...
import com.example.masfdoctor.Person;

import java.io.FileNotFoundException;
import java.io.IOException;
import java.net.URI;

public class HealthUpdates extends AppCompatActivity {
    ...
    public static final String DATABASE_PATH ="healthupdates";
    private Uri imageUri;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_health_updates);
